		...
		open(url) do |rss|
		    ...
		    feed.items.each do |item|
		    	...
		    	#	return
			    	...
			    	@article = @source.articles.create(author: nil, title: item.title, summary: interpret_summary(item.description),img: interpret_image(item.description), link: item.link, pub_date: item.pubDate)
			    	# Add tags
